...
func RequestTimeout(timeout time.Duration) func(option *requestOption) {
	return func(option *requestOption) {
		option.timeout = timeout
	}
}

func NewRequestWithOption(opts ...func(option *requestOption)) *Request {
	...
	return &Request{
		client: &http.Client{Timeout: requestOpt.timeout},
	}
}
